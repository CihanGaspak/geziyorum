...
class IstanbulGezme extends StatefulWidget {
  const IstanbulGezme({Key? key});

  @override
  State<IstanbulGezme> createState() => _IstanbulGezmeState();
}

class _IstanbulGezmeState extends State<IstanbulGezme> {
  @override
      ...
      child: Scaffold(
        ...
        body: ScrollConfiguration(
          ...
          child: ListView(
            children: [
              MyCustomWidget(
                image: 'assets/sultanahmet.jpg',
                text: 'Uzun Göl',
              ),
              MyCustomWidget(
                image: 'assets/dolmabahce.jpg',
                text: 'Sumela Manastırı',
              ),
            ],
          ),
        ),

...
class IstanbulYemek extends StatefulWidget {
  const IstanbulYemek({Key? key});

  @override
  State<IstanbulYemek> createState() => _IstanbulYemekState();
}

class _IstanbulYemekState extends State<IstanbulYemek> {
  @override
      ...
      child: Scaffold(
        ...
        body: ScrollConfiguration(
          ...
          child: ListView(
            children: [
              MyCustomWidget(
                image: 'assets/istanbul_yemek1.jpg',
                text: 'Ortahisar Lokantası',
              ),
              MyCustomWidget(
                image: 'assets/istanbul_yemek2.jpg',
                text: 'Ortahisar Lokantası',
              ),
            ],
          ),
